...
def setup_everything():
    ...
    #parser.add_argument("--ddp_find_unused_parameters23", type=bool, default=False)
    ...
    ddp_find_unused_parameters = args.ddp_find_unused_parameters23
    logger.info(f"args.ddp_find_unused_parameters23={args.ddp_find_unused_parameters23}")
